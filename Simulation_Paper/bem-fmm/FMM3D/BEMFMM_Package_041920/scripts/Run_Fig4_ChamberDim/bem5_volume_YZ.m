...
Efig = figure('Color','w'); %subplot(131);
...
set(gcf,"Position",figpos); %sset(gcf,"Position",[81 431 1014 1017]);


Efig = figure('Color','w'); %subplot(131);subplot(132);
%  E-field plot: contour plot
if component == 4
...
axis([yminzoom ymaxzoom zmin zmax]); clim([Emin,Emax]);
grid on;
set(gcf,"Position",figpos); %s


Efig = figure('Color','w'); %subplot(131);subplot(133);
%  E-field plot: contour plot
if component == 4
