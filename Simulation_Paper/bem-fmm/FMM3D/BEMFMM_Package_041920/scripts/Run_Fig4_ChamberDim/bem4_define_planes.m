...
delta   = 70e-3; % 3e-3;          %   half plane window, m    
...
yminzoom = ymin;                  % Cross-section posterior edge
ymaxzoom = ymax;                  % Cross-section anterior edge
zmin = -0.5e-3;                   % Cross-section inferior edge
zmax = +2e-3;                     % Cross-section superior edge
