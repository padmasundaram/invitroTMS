...
delta   = 2.0e-2;                 %   half plane window, m    
...
yminzoom = -1.6e-2;               % Cross-section posterior edge
ymaxzoom = +1.6e-2;               % Cross-section anterior edge
...
if showfigs
    ...
    str.EdgeColor = 'none'; str.FaceColor = [0.65 0.65 0.65]; str.FaceAlpha = 0.2;
