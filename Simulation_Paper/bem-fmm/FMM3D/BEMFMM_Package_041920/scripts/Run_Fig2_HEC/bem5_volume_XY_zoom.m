...
bem5_figure_scales_zoom; %_alternative;
...
% Sfig = figure('Color','w'); imagesc(x,y,reshape(Etotal(:, component),Ms,Ms)); clim([Emin,Emax]); setcolormap;
% hold on; 
...
set(L, 'Color', 'k', 'AutoScale', 'on', 'AutoScaleFactor', 1.0, 'LineWidth', 1);
