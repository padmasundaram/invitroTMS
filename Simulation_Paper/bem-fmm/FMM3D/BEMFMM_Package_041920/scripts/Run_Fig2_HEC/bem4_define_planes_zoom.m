...
Z       = 100e-6;                 %   XY Cross-section position, m
delta   = 2e-3;                       %   half plane window, m
...
yminzoom = -2e-3;                   % Cross-section posterior edge
ymaxzoom = +2e-3;                   % Cross-section anterior edge
zmin = -1e-4; %-0.25e-3;                % Cross-section inferior edge
zmax = 400e-6; %0.2e-3 + 0.25e-3;        % Cross-section superior edge
